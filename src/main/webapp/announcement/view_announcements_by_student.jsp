...
<div class="container mx-auto p-6">
  <div class="mb-6 py-5">
    <h1 class="text-3xl font-semibold text-gray-800 text-center">Assigned Announcements</h1>
  </div>
  <!-- Error Message -->
  ...
  <table class="min-w-full table-auto bg-white border-collapse shadow-lg rounded-lg pb-3">
    ...
    %>
    <tr>
      <td colspan="5" class="px-6 py-4 text-center text-gray-600">No announcements assigned to you</td>
    </tr>
    <%
      }
    } catch (Exception e) {
